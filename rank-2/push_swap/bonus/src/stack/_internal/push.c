...
/*   Updated: 2025/03/31 08:49:30 by nduvoid          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	push(t_stack **stack_1, t_stack **stack_2)
{
	...
	if ((*stack_1)->size < 1 || (*stack_2)->size >= (*stack_2)->max_size)
		return ;
	if ((*stack_2)->size > 0)
		ft_memmove(&(*stack_2)->array[1], &(*stack_2)->array[0],
			(*stack_2)->size * sizeof(t_nb));
	(*stack_2)->array[0] = (*stack_1)->array[0];
	if ((*stack_1)->size > 1)
		ft_memmove(&(*stack_1)->array[0], &(*stack_1)->array[1],
			((*stack_1)->size - 1) * sizeof(t_nb));
	(*stack_1)->size--;
	(*stack_2)->size++;
}
